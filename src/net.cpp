...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Expertcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"exptcoin.com", "188.226.169.179"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"exptcoin.com", "127.0.0.1"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Expertcoin is probably already running."), addrBind.ToString().c_str());
        else
